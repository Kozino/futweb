...
export type IconName =
  | 'grid' | 'user' | 'users' | 'radar' | 'chart' | 'video' | 'target' | 'shield'
  | 'card' | 'search' | 'list' | 'doc' | 'alert' | 'check' | 'check-circle' | 'x' | 'x-circle'
  | 'chevron-down' | 'chevron-right' | 'chevron-left' | 'arrow-right' | 'arrow-up' | 'arrow-down'
  | 'menu' | 'bell' | 'settings' | 'logout' | 'plus' | 'minus' | 'edit' | 'trash'
  | 'star' | 'star-filled' | 'clock' | 'globe' | 'lock' | 'eye' | 'eye-off' | 'download'
  | 'upload' | 'share' | 'trending' | 'offline' | 'online' | 'filter' | 'refresh'
  | 'mail' | 'phone' | 'map' | 'calendar' | 'trophy' | 'whistle' | 'zap' | 'info'
  | 'help' | 'external' | 'copy' | 'more' | 'sun' | 'moon' | 'building' | 'flag'
  | 'chat' | 'send'
...
const PATHS: Record<IconName, string> = {
  ...
  radar: 'M12 12 3 8v8l9-4zM12 12l9-4v8l-9-4zM12 12v9M12 12V3',
  ...
  online: 'M5 12.55a11 11 0 0 1 14.08 0M1.42 9a16 16 0 0 1 21.16 0M8.53 16.11a6 6 0 0 1 6.95 0M12 20h.01',
  ...
  calendar: 'M5 4h14a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1zM16 2v4M8 2v4M3 10h18',
  trophy: 'M8 21h8M12 17v4M7 4h10v5a5 5 0 0 1-10 0V4zM7 5H4v2a3 3 0 0 0 3 3M17 5h3v2a3 3 0 0 1-3 3',
  whistle: 'M12 2a5 5 0 0 0-5 5v4a5 5 0 0 0 10 0V7a5 5 0 0 0-5-5zM12 16v6M9 22h6',
  ...
  building: 'M4 22V4a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v18M16 8h4a1 1 0 0 1 1 1v13M8 7h4M8 11h4M8 15h4M2 22h20',
...
export function Icon({ name, size = 20, strokeWidth = 2, filled = false, className, ...rest }: IconProps) {
  return (
    <svg
