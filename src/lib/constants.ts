...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Multi-academy / group management',
      'Federation overview of every academy squad',
      'Add-on: SSO, data residency, API & webhook streams',
      'Add-on: custom SLA & named account manager',
      'Add-on: dedicated onboarding & NFF compliance support',
    ],
  },
]
...
export const NAV_BY_ROLE = {
  ...
  club: [
    ...
    { label: 'Audit log', to: '/club/audit', icon: 'doc', roles: ['club_admin', 'club_staff'] },
    { label: 'Messages', to: '/messages', icon: 'chat', roles: ['club_admin', 'club_staff'] },
